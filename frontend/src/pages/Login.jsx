...
const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-[calc(100vh-64px)] px-4 bg-slate-50 dark:bg-slate-900/40">
      ...
      >
        <h2 className="text-3xl font-bold mb-6 text-center tracking-tight text-slate-800 dark:text-slate-100">Welcome Back</h2>
        <p className="text-slate-500 text-center mb-8">Access your personalized self-improvement hub.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="relative group">
            ...
            <input
              ...
              className="w-full bg-slate-100 dark:bg-slate-800/50 border border-transparent focus:border-violet-500/50 rounded-2xl py-4 pl-12 pr-4 outline-none transition-all"
